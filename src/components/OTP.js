...
function OTP() {
    const location = useLocation();
    const AppUserId = location.state ? location.state.AppUserId : '';
    const PrimaryContact = location.state ? location.state.PrimaryContact : '';
    const [formData, setFormData] = useState({
        otp: ''
    });
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await fetch('http://127.0.0.1:3003/verify-otp', {
                ...
                mode: 'cors',
                body: JSON.stringify({ AppUserId: AppUserId, PrimaryContact: PrimaryContact, otp: formData.otp }),
            });
    ...
    return (
        <>
            <div className="otp-container">
                <div className="otp-split left" >
                    <div className="text-center">
                        <img src={welcomeImage} alt="Welcome Image" className="mt-5 mb-5" />
                        <h1>Welcome to our platform</h1>
                        <p style={{ color: 'black' }}>Enter OTP to verify</p>
                    </div>
                </div>
                <div className="otp-split right" >
                    <div className="otp-centered">
                        <form onSubmit={handleSubmit}>
                            <div className="otp-form-group mb-4">
                            ...
                            <button type="submit" className="otp-btn btn-primary mb-4">
                                Verify OTP
                            </button>
                        </form>
                        {successMessage && <div className="text-success">{successMessage}</div>}
