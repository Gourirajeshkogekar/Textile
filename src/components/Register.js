...
//                                             <button className="btn btn-primary btn-block fa-sm gradient-custom-2 mb-3 mt-4" type="button" onClick={handleSubmit}>SignUp
//                                             </button>
...
//                                             <button type="button" className="btn btn-outline-danger" onClick={handleLogin}>Login</button>
//                                         </div>
...
function Register() {
    ...
    const handleSubmit = async (e) => {
        ...
        const PrimaryContact = `+91${formData.PrimaryContact}`;
        ...
        if (Object.keys(errors).length === 0) {
            try {
                ...
                if (response.status === 200) {
                    setSuccessMessage('User registered successfully');
                    navigate('/otp', { state: { AppUserId: formData.AppUserId, PrimaryContact: formData.PrimaryContact } });
                } else {
                    throw new Error('Failed to register user');
                }
            } catch (error) {
    ...
    return (
        <div className="reg-container">
            <div className="reg-split left">
                <div className="text-center ">
                    <img src={welcomeImage} alt="Welcome Image" className="mb-5 mt-5" />
                    <h1>Welcome to our platform</h1>
                    <p style={{ color: 'black' }}>Sign up to get started</p>
                </div>
            </div>
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="row">
                            <div className='col-md-6'>
                                ...
                                <input type="email" name='AppUserId' value={formData.AppUserId} onChange={handleInputChange} className="reg-form-control" placeholder='Enter email address' />
                        ...
                        <button className="reg-btn btn-primary w-50 mt-3" type="submit">Sign Up</button>
                    </form>
                    <div className="text-center mt-3">
                        <p style={{ color: 'black' }}>Already registered? <button className="reg-btn btn-primary w-50 mt-3" onClick={handleLogin}>Login</button></p>
                    </div>
                    {successMessage && <div className="text-success">{successMessage}</div>}
                </div>
            </div>
