...
// //                 // Call handleAuthentication with true to indicate successful authentication
        ...
        <div className="login-container">
            <div className="login-split left">
                <div className="login-centered">
                    ...
                    <p>The textile industry encompasses the production of fibers, yarns, fabrics, and finished textile products, playing a crucial role in global economies. It involves various processes such as spinning, weaving, knitting, dyeing, and finishing, and it serves diverse sectors including fashion, home furnishings, automotive, and healthcare.</p>
                </div>
            </div>
